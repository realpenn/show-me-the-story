...
- **Project types**: choose an original-novel project or an authorised rewrite project; rewrite projects import authorised TXT references, build structured reference analysis, manage rewrite requests and confirm an adaptation master plan
