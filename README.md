...
- **项目类型**：创建时可选择原创小说或授权改写项目；改写项目用于导入已获授权的 TXT 参考小说并生成结构化参考分析
...
- **授权参考改写（阶段 1）**：导入 TXT 参考小说，自动拆章、审核章节边界、分批分析全书结构，并抽取角色 / 世界观 / 组织 / 关系候选
...
后续的改写意见、改编总方案、逐章完全重写、相似度检查和改写报告会按后续阶段继续实现。
